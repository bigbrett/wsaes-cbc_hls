...
wire   [3:0] tmp_11_fu_93_p1;
reg   [3:0] tmp_11_reg_492;
reg   [3:0] buf_addr_1_reg_498;
wire   [4:0] i_1_fu_108_p2;
reg   [4:0] i_1_reg_503;
reg   [7:0] a_reg_508;
wire   [0:0] ap_CS_fsm_state3;
reg   [7:0] b_reg_516;
reg   [3:0] buf_addr_2_reg_524;
reg   [3:0] buf_addr_3_reg_529;
reg   [7:0] c_reg_534;
...
reg   [7:0] tmp_5_reg_568;
wire   [0:0] ap_CS_fsm_state5;
wire   [7:0] tmp_6_fu_393_p2;
reg   [7:0] tmp_6_reg_573;
wire   [7:0] tmp_8_fu_436_p2;
reg   [7:0] tmp_8_reg_578;
wire   [7:0] tmp_10_fu_479_p2;
reg   [7:0] tmp_10_reg_583;
reg   [4:0] i_reg_69;
wire   [0:0] ap_CS_fsm_state7;
wire   [63:0] tmp_7_fu_88_p1;
wire   [63:0] tmp_s_fu_103_p1;
wire   [63:0] tmp_2_fu_119_p1;
wire   [63:0] tmp_4_fu_129_p1;
wire   [0:0] ap_CS_fsm_state6;
wire   [3:0] tmp_9_fu_97_p2;
wire   [3:0] tmp_1_fu_114_p2;
wire   [3:0] tmp_3_fu_124_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        a_reg_508 <= buf_r_q0;
        b_reg_516 <= buf_r_q1;
        buf_addr_2_reg_524[0] <= tmp_2_fu_119_p1[0];
buf_addr_2_reg_524[3 : 2] <= tmp_2_fu_119_p1[3 : 2];
        buf_addr_3_reg_529[3 : 2] <= tmp_4_fu_129_p1[3 : 2];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_fu_80_p3 == 1'b0))) begin
        buf_addr_1_reg_498[3 : 1] <= tmp_s_fu_103_p1[3 : 1];
        buf_addr_reg_487 <= tmp_7_fu_88_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        ...
        buf_r_address0 = tmp_2_fu_119_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_r_address0 = tmp_7_fu_88_p1;
    end else begin
        buf_r_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        ...
        buf_r_address1 = tmp_4_fu_129_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        buf_r_address1 = tmp_s_fu_103_p1;
    end else begin
        buf_r_address1 = 'bx;
    end
end
...
assign i_1_fu_108_p2 = (ap_const_lv5_4 + i_reg_69);
...
assign tmp_10_fu_479_p2 = (tmp7_fu_473_p2 ^ d_reg_542);

assign tmp_11_fu_93_p1 = i_reg_69[3:0];

assign tmp_13_fu_156_p3 = e_fu_144_p2[ap_const_lv32_7];

assign tmp_15_fu_193_p3 = x_assign_1_fu_182_p2[ap_const_lv32_7];

assign tmp_17_fu_221_p3 = y_4_fu_207_p3[ap_const_lv32_7];

assign tmp_19_fu_263_p3 = x_assign_3_fu_252_p2[ap_const_lv32_7];

assign tmp_1_fu_114_p2 = (tmp_11_reg_492 | ap_const_lv4_2);
...
assign tmp_21_fu_291_p3 = y_8_fu_277_p3[ap_const_lv32_7];

assign tmp_23_fu_323_p3 = x_assign_5_reg_550[ap_const_lv32_7];

assign tmp_25_fu_365_p3 = x_assign_6_fu_355_p2[ap_const_lv32_7];

assign tmp_27_fu_408_p3 = x_assign_7_fu_398_p2[ap_const_lv32_7];

assign tmp_29_fu_451_p3 = x_assign_8_fu_441_p2[ap_const_lv32_7];

assign tmp_2_fu_119_p1 = tmp_1_fu_114_p2;

assign tmp_3_fu_124_p2 = (tmp_11_reg_492 | ap_const_lv4_3);

assign tmp_4_fu_129_p1 = tmp_3_fu_124_p2;

assign tmp_5_fu_350_p2 = (tmp4_fu_344_p2 ^ a_reg_508);

assign tmp_6_fu_393_p2 = (tmp5_fu_387_p2 ^ b_reg_516);

assign tmp_7_fu_88_p1 = i_reg_69;

assign tmp_8_fu_436_p2 = (tmp6_fu_430_p2 ^ c_reg_534);

assign tmp_9_fu_97_p2 = (tmp_11_fu_93_p1 | ap_const_lv4_1);

assign tmp_fu_80_p3 = i_reg_69[ap_const_lv32_4];

assign tmp_s_fu_103_p1 = tmp_9_fu_97_p2;
...
assign y_10_fu_305_p3 = ((tmp_21_fu_291_p3[0:0] === 1'b1) ? tmp_1_i4_fu_299_p2 : y_9_fu_285_p2);

assign y_11_fu_318_p2 = x_assign_5_reg_550 << ap_const_lv8_1;

assign y_12_fu_336_p3 = ((tmp_23_fu_323_p3[0:0] === 1'b1) ? tmp_1_i5_fu_330_p2 : y_11_fu_318_p2);

assign y_13_fu_359_p2 = x_assign_6_fu_355_p2 << ap_const_lv8_1;

assign y_14_fu_379_p3 = ((tmp_25_fu_365_p3[0:0] === 1'b1) ? tmp_1_i6_fu_373_p2 : y_13_fu_359_p2);

assign y_15_fu_402_p2 = x_assign_7_fu_398_p2 << ap_const_lv8_1;

assign y_16_fu_422_p3 = ((tmp_27_fu_408_p3[0:0] === 1'b1) ? tmp_1_i7_fu_416_p2 : y_15_fu_402_p2);

assign y_17_fu_445_p2 = x_assign_8_fu_441_p2 << ap_const_lv8_1;

assign y_18_fu_465_p3 = ((tmp_29_fu_451_p3[0:0] === 1'b1) ? tmp_1_i8_fu_459_p2 : y_17_fu_445_p2);

assign y_19_fu_170_p3 = ((tmp_13_fu_156_p3[0:0] === 1'b1) ? tmp_1_i_fu_164_p2 : y_1_fu_150_p2);

assign y_1_fu_150_p2 = e_fu_144_p2 << ap_const_lv8_1;

assign y_3_fu_187_p2 = x_assign_1_fu_182_p2 << ap_const_lv8_1;

assign y_4_fu_207_p3 = ((tmp_15_fu_193_p3[0:0] === 1'b1) ? tmp_1_i1_fu_201_p2 : y_3_fu_187_p2);

assign y_5_fu_215_p2 = y_4_fu_207_p3 << ap_const_lv8_1;

assign y_6_fu_235_p3 = ((tmp_17_fu_221_p3[0:0] === 1'b1) ? tmp_1_i2_fu_229_p2 : y_5_fu_215_p2);

assign y_7_fu_257_p2 = x_assign_3_fu_252_p2 << ap_const_lv8_1;

assign y_8_fu_277_p3 = ((tmp_19_fu_263_p3[0:0] === 1'b1) ? tmp_1_i3_fu_271_p2 : y_7_fu_257_p2);
...
always @ (posedge ap_clk) begin
    buf_addr_1_reg_498[0] <= 1'b1;
    buf_addr_2_reg_524[1] <= 1'b1;
    buf_addr_3_reg_529[1:0] <= 2'b11;
end
