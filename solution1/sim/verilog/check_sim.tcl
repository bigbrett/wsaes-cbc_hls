...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.aes256cbc.autotvin_memptr.dat"
         "c.aes256cbc.autotvin_mode.dat"
         "c.aes256cbc.autotvin_inbuf_addr.dat"
         "c.aes256cbc.autotvin_outbuf_addr.dat"
         "c.aes256cbc.autotvout_memptr.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.aes256cbc.autotvout_memptr.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
