...
if {[file isfile aes256cbc.autotvin.dat]} {
	file delete -force aes256cbc.autotvin.dat
}

if {[file isfile aes256cbc.autotvout.dat]} {
	file delete -force aes256cbc.autotvout.dat
}
