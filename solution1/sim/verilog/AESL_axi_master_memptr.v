...
parameter memptr_mem_depth = 32'd 64;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > memptr_mem_depth) begin
                $display ("/home/jd/workspace/aes256cbc/solution1/sim/verilog/AESL_axi_master_memptr.v: Write request address %d exceed AXI master memptr array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, memptr_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > memptr_mem_depth) begin
                $display ("/home/jd/workspace/aes256cbc/solution1/sim/verilog/AESL_axi_master_memptr.v: Read request address %d exceed AXI master memptr array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, memptr_mem_depth); 
                $finish;
            end
