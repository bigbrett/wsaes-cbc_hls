...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "aescbc.autotvin.dat"
	set constFileTvOut       "aescbc.autotvout.dat"
	set constFileHdlTvIn     "aescbc.autohdltvin.dat"
	set constFileHdlTvOut    "aescbc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
