...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "aes256cbc.autotvin.dat"
	set constFileTvOut       "aes256cbc.autotvout.dat"
	set constFileHdlTvIn     "aes256cbc.autohdltvin.dat"
	set constFileHdlTvOut    "aes256cbc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
