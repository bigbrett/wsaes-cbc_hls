...
$(ObjDir)/aescbc_tb.c_pre.c.tb.o : aescbc_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) aescbc_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/aescbc.c_pre.c.tb.o : aescbc.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) aescbc.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/aesecb.c_pre.c.tb.o : aesecb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) aesecb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
