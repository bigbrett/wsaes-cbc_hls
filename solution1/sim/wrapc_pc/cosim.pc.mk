...
$(ObjDir)/aes256cbc_tb.c_pre.c.tb.o : aes256cbc_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) aes256cbc_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/aes256cbc.c_pre.c.tb.o : aes256cbc.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) aes256cbc.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/aes256ecb.c_pre.c.tb.o : aes256ecb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) aes256ecb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
