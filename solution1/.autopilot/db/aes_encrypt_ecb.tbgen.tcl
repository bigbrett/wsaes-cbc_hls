set moduleName aes_encrypt_ecb
...
set C_modelName {aes_encrypt_ecb}
set C_modelType { void 0 }
set C_modelArgList {
	{ buf_r int 8 regular {array 16 { 2 2 } 1 1 }  }
	{ ctx_enckey int 8 regular {array 32 { 1 1 } 1 1 } {global 0}  }
	{ ctx_key int 8 regular {array 32 { 2 2 } 1 1 } {global 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "buf_r", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "ctx_enckey", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ ctx_enckey_address0 sc_out sc_lv 5 signal 1 } 
	{ ctx_enckey_ce0 sc_out sc_logic 1 signal 1 } 
	{ ctx_enckey_q0 sc_in sc_lv 8 signal 1 } 
	{ ctx_enckey_address1 sc_out sc_lv 5 signal 1 } 
	{ ctx_enckey_ce1 sc_out sc_logic 1 signal 1 } 
	{ ctx_enckey_q1 sc_in sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ctx_enckey_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "ctx_enckey", "role": "address0" }} , 
 	{ "name": "ctx_enckey_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ctx_enckey", "role": "ce0" }} , 
 	{ "name": "ctx_enckey_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "ctx_enckey", "role": "q0" }} , 
 	{ "name": "ctx_enckey_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "ctx_enckey", "role": "address1" }} , 
 	{ "name": "ctx_enckey_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ctx_enckey", "role": "ce1" }} , 
 	{ "name": "ctx_enckey_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "ctx_enckey", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4"],
		...
		{"Name" : "buf_r", "Type" : "Memory", "Direction" : "IO",
			"SubConnect" : [
			{"ID" : "4", "SubInstance" : "grp_aes_addRoundKey_fu_377", "Port" : "buf_r"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_expandEncKey_fu_368", "Parent" : "0", "Child" : ["3"],
		...
		{"Name" : "sbox", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_expandEncKey_fu_368.sbox_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_addRoundKey_fu_377", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1698", "Max" : "2335"}
	, {"Name" : "Interval", "Min" : "1698", "Max" : "2335"}
]}
...
set Spec2ImplPortList { 
	...
	ctx_enckey { ap_memory {  { ctx_enckey_address0 mem_address 1 5 }  { ctx_enckey_ce0 mem_ce 1 1 }  { ctx_enckey_q0 mem_dout 0 8 }  { ctx_enckey_address1 mem_address 1 5 }  { ctx_enckey_ce1 mem_ce 1 1 }  { ctx_enckey_q1 mem_dout 0 8 } } }
