...
`define AUTOTB_DUT      aescbc
`define AUTOTB_DUT_INST AESL_inst_aescbc
`define AUTOTB_TOP      apatb_aescbc_top
`define AUTOTB_LAT_RESULT_FILE "aescbc.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "aescbc.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_aescbc_top
...
`define AUTOTB_TVIN_data_in  "./c.aescbc.autotvin_data_in.dat"
`define AUTOTB_TVIN_mode  "./c.aescbc.autotvin_mode.dat"
`define AUTOTB_TVIN_key_in  "./c.aescbc.autotvin_key_in.dat"
`define AUTOTB_TVIN_iv_in  "./c.aescbc.autotvin_iv_in.dat"
`define AUTOTB_TVIN_data_in_out_wrapc  "./rtl.aescbc.autotvin_data_in.dat"
`define AUTOTB_TVIN_mode_out_wrapc  "./rtl.aescbc.autotvin_mode.dat"
`define AUTOTB_TVIN_key_in_out_wrapc  "./rtl.aescbc.autotvin_key_in.dat"
`define AUTOTB_TVIN_iv_in_out_wrapc  "./rtl.aescbc.autotvin_iv_in.dat"
`define AUTOTB_TVOUT_data_out  "./c.aescbc.autotvout_data_out.dat"
`define AUTOTB_TVOUT_data_out_out_wrapc  "./impl_rtl.aescbc.autotvout_data_out.dat"
module `AUTOTB_TOP;
