...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename ctx_enckey \
    op interface \
    ports { ctx_enckey_address0 { O 5 vector } ctx_enckey_ce0 { O 1 bit } ctx_enckey_q0 { I 8 vector } ctx_enckey_address1 { O 5 vector } ctx_enckey_ce1 { O 1 bit } ctx_enckey_q1 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'ctx_enckey'"
}
}
