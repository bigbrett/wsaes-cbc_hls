...
architecture behav of aes256_encrypt_ecb is 
    ...
    signal tmp_93_fu_578_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state40 : STD_LOGIC_VECTOR (0 downto 0);
    attribute fsm_encoding of ap_CS_fsm_state40 : signal is "none";
    signal i_14_fu_467_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_14_reg_829 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC_VECTOR (0 downto 0);
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_i_33_fu_483_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_i_33_reg_837 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal i_16_fu_518_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_16_reg_944 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal tmp_94_fu_557_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_94_reg_971 : STD_LOGIC_VECTOR (3 downto 0);
    signal buf_addr_26_reg_977 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_21_fu_572_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_21_reg_982 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_93_reg_987 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_22_fu_797_p2 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal i_15_reg_1026 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i_15_cast_fu_473_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_178_i_fu_489_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_17_cast_fu_524_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_96_fu_626_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_98_fu_672_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_100_fu_718_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_102_fu_764_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_i18_i_fu_772_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal y_27_fu_778_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_16_cast_fu_809_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((((ap_const_lv1_1 = ap_CS_fsm_state19) and not((tmp_fu_544_p3 = ap_const_lv1_0)) and not((ap_const_lv1_0 = tmp_93_fu_578_p1))) or ((ap_const_lv1_1 = ap_CS_fsm_state25)) or ((ap_const_lv1_1 = ap_CS_fsm_state42)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((((ap_const_lv1_1 = ap_CS_fsm_state19) and not((tmp_fu_544_p3 = ap_const_lv1_0)) and (ap_const_lv1_0 = tmp_93_fu_578_p1)) or ((ap_const_lv1_1 = ap_CS_fsm_state40)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_lv1_1 = ap_CS_fsm_state26) and not(((ap_const_lv1_0 = tmp_93_reg_987) and (ap_const_logic_0 = grp_aes_addRoundKey_fu_377_ap_done))))) then 
                i_reg_323 <= i_22_fu_797_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (ap_const_lv1_0 = tmp_i_fu_477_p2))) then
                buf_addr_22_reg_847 <= tmp_i_33_fu_483_p1(4 - 1 downto 0);
                    tmp_179_i_reg_852(4 downto 0) <= tmp_179_i_fu_495_p1(4 downto 0);
                    tmp_i_33_reg_837(7 downto 0) <= tmp_i_33_fu_483_p1(7 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state19) and (tmp_fu_544_p3 = ap_const_lv1_0))) then
                ...
                i_21_reg_982 <= i_21_fu_572_p2;
                tmp_94_reg_971 <= tmp_94_fu_557_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state19) and not((tmp_fu_544_p3 = ap_const_lv1_0)))) then
                tmp_93_reg_987 <= tmp_93_fu_578_p1;
            end if;
        end if;
    end process;
    tmp_i_33_reg_837(63 downto 8) <= "00000000000000000000000000000000000000000000000000000000";
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, tmp_fu_544_p3, tmp_93_fu_578_p1, tmp_i_fu_477_p2, tmp_i5_fu_528_p2, tmp_93_reg_987, grp_aes_addRoundKey_fu_377_ap_done, tmp_i8_fu_813_p2, grp_aes_expandEncKey_fu_368_ap_done, exitcond_fu_512_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state19 => 
                if ((not((tmp_fu_544_p3 = ap_const_lv1_0)) and not((ap_const_lv1_0 = tmp_93_fu_578_p1)))) then
                    ap_NS_fsm <= ap_ST_fsm_state27;
                elsif ((not((tmp_fu_544_p3 = ap_const_lv1_0)) and (ap_const_lv1_0 = tmp_93_fu_578_p1))) then
            ...
            when ap_ST_fsm_state26 => 
                if (not(((ap_const_lv1_0 = tmp_93_reg_987) and (ap_const_logic_0 = grp_aes_addRoundKey_fu_377_ap_done)))) then
                    ap_NS_fsm <= ap_ST_fsm_state4;
                else
                    ap_NS_fsm <= ap_ST_fsm_state26;
                end if;
    ...
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state35)) or ((ap_const_lv1_1 = ap_CS_fsm_state41)))) then 
            ...
            buf_r_address0 <= tmp_i_33_fu_483_p1(4 - 1 downto 0);
        elsif ((((ap_const_lv1_1 = ap_CS_fsm_state27)) or ((ap_const_lv1_1 = ap_CS_fsm_state26) and (ap_const_lv1_0 = tmp_93_reg_987)) or ((ap_const_lv1_1 = ap_CS_fsm_state43)))) then 
            buf_r_address0 <= grp_aes_addRoundKey_fu_377_buf_r_address0;
        else 
            buf_r_address0 <= "XXXX";
        end if; 
    ...
    buf_r_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state20, ap_CS_fsm_state31, ap_CS_fsm_state13, ap_CS_fsm_state36, ap_CS_fsm_state9, ap_CS_fsm_state32, ap_CS_fsm_state10, ap_CS_fsm_state33, ap_CS_fsm_state11, ap_CS_fsm_state34, ap_CS_fsm_state12, ap_CS_fsm_state35, ap_CS_fsm_state19, tmp_fu_544_p3, ap_CS_fsm_state40, ap_CS_fsm_state2, ap_CS_fsm_state5, tmp_i5_fu_528_p2, tmp_93_reg_987, ap_CS_fsm_state26, ap_CS_fsm_state28, grp_aes_expandEncKey_fu_368_ap_done, grp_aes_addRoundKey_fu_377_buf_r_ce0, ap_CS_fsm_state3, ap_CS_fsm_state18, ap_CS_fsm_state23, ap_CS_fsm_state41, ap_CS_fsm_state27, ap_CS_fsm_state43, ap_CS_fsm_state14, ap_CS_fsm_state15, ap_CS_fsm_state16, ap_CS_fsm_state17, ap_CS_fsm_state22, ap_CS_fsm_state37, ap_CS_fsm_state38, ap_CS_fsm_state39)
    begin
    ...
    buf_r_d0_assign_proc : process(reg_392, reg_399, ap_CS_fsm_state13, ap_CS_fsm_state36, reg_406, reg_413, reg_420, reg_427, reg_434, reg_441, reg_448, reg_455, ap_CS_fsm_state40, tmp_93_reg_987, tmp_48_i_reg_1006, tmp_56_i_reg_1016, ap_CS_fsm_state26, grp_aes_addRoundKey_fu_377_buf_r_d0, ap_CS_fsm_state3, ap_CS_fsm_state18, ap_CS_fsm_state23, ap_CS_fsm_state41, ap_CS_fsm_state27, ap_CS_fsm_state43, tmp_176_i_fu_505_p2, ap_CS_fsm_state14, ap_CS_fsm_state15, ap_CS_fsm_state16, ap_CS_fsm_state17, ap_CS_fsm_state22, ap_CS_fsm_state37, ap_CS_fsm_state38, ap_CS_fsm_state39)
    begin
    ...
    buf_r_we0_assign_proc : process(ap_CS_fsm_state13, ap_CS_fsm_state36, ap_CS_fsm_state40, tmp_93_reg_987, ap_CS_fsm_state26, grp_aes_expandEncKey_fu_368_ap_done, grp_aes_addRoundKey_fu_377_buf_r_we0, ap_CS_fsm_state3, ap_CS_fsm_state18, ap_CS_fsm_state23, ap_CS_fsm_state41, ap_CS_fsm_state27, ap_CS_fsm_state43, ap_CS_fsm_state14, ap_CS_fsm_state15, ap_CS_fsm_state16, ap_CS_fsm_state17, ap_CS_fsm_state22, ap_CS_fsm_state37, ap_CS_fsm_state38, ap_CS_fsm_state39)
    begin
    ...
    ctx_enckey_address0 <= tmp_i_33_fu_483_p1(5 - 1 downto 0);
    ...
    ctx_key_address0_assign_proc : process(tmp_i_33_reg_837, tmp_93_reg_987, ap_CS_fsm_state26, grp_aes_expandEncKey_fu_368_k_address0, grp_aes_addRoundKey_fu_377_key_address0, ap_CS_fsm_state3, ap_CS_fsm_state24, ap_CS_fsm_state41, ap_CS_fsm_state27, ap_CS_fsm_state43)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state3))) then 
            ctx_key_address0 <= tmp_i_33_reg_837(5 - 1 downto 0);
        elsif ((((ap_const_lv1_1 = ap_CS_fsm_state27)) or ((ap_const_lv1_1 = ap_CS_fsm_state26) and (ap_const_lv1_0 = tmp_93_reg_987)) or ((ap_const_lv1_1 = ap_CS_fsm_state43)))) then 
    ...
    ctx_key_ce0_assign_proc : process(tmp_93_reg_987, ap_CS_fsm_state26, grp_aes_expandEncKey_fu_368_k_ce0, grp_aes_addRoundKey_fu_377_key_ce0, ap_CS_fsm_state3, ap_CS_fsm_state24, ap_CS_fsm_state41, ap_CS_fsm_state27, ap_CS_fsm_state43)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state3))) then 
    ...
    grp_aes_addRoundKey_fu_377_key_offset_assign_proc : process(tmp_93_reg_987, ap_CS_fsm_state26, ap_CS_fsm_state27, ap_CS_fsm_state43)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state26) and (ap_const_lv1_0 = tmp_93_reg_987)) or ((ap_const_lv1_1 = ap_CS_fsm_state43)))) then 
    ...
    i_14_fu_467_p2 <= std_logic_vector(unsigned(i_i_reg_312) + unsigned(ap_const_lv5_1F));
        i_15_cast_fu_473_p1 <= std_logic_vector(resize(signed(i_14_fu_467_p2),8));

    i_15_fu_803_p2 <= std_logic_vector(unsigned(i_i1_reg_357) + unsigned(ap_const_lv5_1F));
        i_16_cast_fu_809_p1 <= std_logic_vector(resize(signed(i_15_fu_803_p2),8));

    i_16_fu_518_p2 <= std_logic_vector(unsigned(i_i4_reg_335) + unsigned(ap_const_lv5_1F));
        i_17_cast_fu_524_p1 <= std_logic_vector(resize(signed(i_16_fu_518_p2),8));

    i_21_fu_572_p2 <= std_logic_vector(unsigned(ap_const_lv5_4) + unsigned(i_i2_reg_346));
    i_22_fu_797_p2 <= std_logic_vector(unsigned(i_reg_323) + unsigned(ap_const_lv4_1));
    ...
    tmp_100_fu_718_p3 <= x_assign_s_fu_706_p2(7 downto 7);
    tmp_102_fu_764_p3 <= x_assign_1_fu_752_p2(7 downto 7);
    ...
    tmp_34_i_fu_561_p2 <= (tmp_94_fu_557_p1 or ap_const_lv4_1);
    tmp_35_i_fu_567_p1 <= std_logic_vector(resize(unsigned(tmp_34_i_fu_561_p2),64));
    tmp_36_i_fu_582_p2 <= (tmp_94_reg_971 or ap_const_lv4_2);
    tmp_37_i_fu_587_p1 <= std_logic_vector(resize(unsigned(tmp_36_i_fu_582_p2),64));
    tmp_38_i_fu_592_p2 <= (tmp_94_reg_971 or ap_const_lv4_3);
    ...
    tmp_5_i1_fu_819_p1 <= std_logic_vector(resize(unsigned(i_16_cast_fu_809_p1),64));
    tmp_5_i_fu_534_p1 <= std_logic_vector(resize(unsigned(i_17_cast_fu_524_p1),64));
    ...
    tmp_93_fu_578_p1 <= i_reg_323(1 - 1 downto 0);
    tmp_94_fu_557_p1 <= i_i2_reg_346(4 - 1 downto 0);
    tmp_96_fu_626_p3 <= x_assign_fu_602_p2(7 downto 7);
    tmp_98_fu_672_p3 <= x_assign_9_fu_660_p2(7 downto 7);
    ...
    tmp_i_33_fu_483_p1 <= std_logic_vector(resize(unsigned(i_15_cast_fu_473_p1),64));
    ...
    y_21_fu_640_p3 <= 
        tmp_1_i_i_fu_634_p2 when (tmp_96_fu_626_p3(0) = '1') else 
        y_fu_620_p2;
    ...
    y_23_fu_686_p3 <= 
        tmp_1_i10_i_fu_680_p2 when (tmp_98_fu_672_p3(0) = '1') else 
        y_22_fu_666_p2;
    ...
    y_25_fu_732_p3 <= 
        tmp_1_i14_i_fu_726_p2 when (tmp_100_fu_718_p3(0) = '1') else 
        y_24_fu_712_p2;
    ...
    y_27_fu_778_p3 <= 
        tmp_1_i18_i_fu_772_p2 when (tmp_102_fu_764_p3(0) = '1') else 
        y_26_fu_758_p2;
