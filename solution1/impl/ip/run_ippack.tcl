...
set Library     "hls"
set IPName      "aes256cbc"
set Version     "1.0"
set DisplayName "aes256cbc"
set Revision    "1704031908"
set Description "AES 256 CBC"
set Device      "zynq"
...
set Interfaces {
    ...
    s_axi_p0 {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_p0"
        param_prefix "C_S_AXI_P0"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 mode W 0x0 "Data signal of mode" {{0 3 mode W 0 "Bit 2 to 0 Data signal of mode"} {3 29 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 inbuf_addr W 0x0 "Data signal of inbuf_addr" {{0 32 inbuf_addr W 0 "Bit 31 to 0 Data signal of inbuf_addr"}}} {0x20 outbuf_addr W 0x0 "Data signal of outbuf_addr" {{0 32 outbuf_addr W 0 "Bit 31 to 0 Data signal of outbuf_addr"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_p0 m_axi_memptr"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_memptr {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_memptr"
        data_width "32"
        param_prefix "C_M_AXI_MEMPTR"
...
set enable_xo_gen 0
set kernel_files {/thayerfs/home/d36937q/MS/Thesis/Vivado_WS/aes256cbc/src/aes256ecb.c /thayerfs/home/d36937q/MS/Thesis/Vivado_WS/aes256cbc/src/aes256cbc.c}
if {$enable_xo_gen} {
