...
architecture behav of aes_addRoundKey is 
    ...
    signal tmp_92_fu_61_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_92_reg_103 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_5_fu_65_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_5_reg_108 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i_6_cast_fu_71_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    i_5_fu_65_p2 <= std_logic_vector(unsigned(i_reg_50) + unsigned(ap_const_lv5_1F));
        i_6_cast_fu_71_p1 <= std_logic_vector(resize(signed(i_5_fu_65_p2),8));
    ...
    sum_fu_86_p2 <= std_logic_vector(unsigned(i_5_fu_65_p2) + unsigned(tmp_92_reg_103));
    tmp_92_fu_61_p1 <= key_offset(5 - 1 downto 0);
    tmp_fu_75_p2 <= "1" when (i_reg_50 = ap_const_lv5_0) else "0";
    tmp_s_fu_81_p1 <= std_logic_vector(resize(unsigned(i_6_cast_fu_71_p1),64));
end behav;
