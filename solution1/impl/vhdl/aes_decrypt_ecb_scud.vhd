...
entity aes_decrypt_ecb_scud_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of aes_decrypt_ecb_scud_rom is 
...
entity aes_decrypt_ecb_scud is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_decrypt_ecb_scud is
    component aes_decrypt_ecb_scud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_decrypt_ecb_scud_rom_U :  component aes_decrypt_ecb_scud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
