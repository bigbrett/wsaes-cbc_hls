...
entity aes_expandDecKey_bkb_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of aes_expandDecKey_bkb_rom is 
...
entity aes_expandDecKey_bkb is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_expandDecKey_bkb is
    component aes_expandDecKey_bkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_expandDecKey_bkb_rom_U :  component aes_expandDecKey_bkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
