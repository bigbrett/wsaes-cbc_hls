...
entity aes_expandEncKey_dEe_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of aes_expandEncKey_dEe_rom is 
...
entity aes_expandEncKey_dEe is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes_expandEncKey_dEe is
    component aes_expandEncKey_dEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_expandEncKey_dEe_rom_U :  component aes_expandEncKey_dEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
